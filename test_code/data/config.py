...
# train config
# 201006: _C.LR_STEPS = (80000,100000,120000)
# 201011: _C.LR_STEPS = (100000,300000)
...
# dataset config
_C.DSFD_RESUME = './weights/dsfd_vgg_0.880.pth'

# face config
_C.FACE = EasyDict()
_C.FACE.SRC_TRAIN_FILE = './dataset/wider_face_train.txt'
_C.FACE.TAR_TRAIN_FILE = './dataset/dark_face_train.txt'
_C.FACE.SRC_VAL_FILE = './dataset/wider_face_val.txt'
_C.FACE.TAR_VAL_FILE = './dataset/dark_face_train.txt'
_C.FACE.VAL_FILE = './dataset/dark_face_test.txt'
_C.FACE.OVERLAP_THRESH = 0.35
_C.FACE.PRE_IMAGE_FILE = './dataset/pre_image_train.txt'
...
_C.TRAIN_WEIGHT.RECONSTRUCTION = 1
